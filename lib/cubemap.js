...
Cubemap.prototype.buildFace = function(face, url)
{
	...
	switch(face)
	{
		case 'front': transform = "translateZ(-"+halfsize.toFixed(1)+"px) rotateY(0deg) rotateX(180deg) rotateZ(180deg)"; break;
		case 'left': transform = "translateX(-"+halfsize.toFixed(1)+"px) rotateY(90deg) rotateX(180deg) rotateZ(180deg)"; break;
		case 'right': transform = "translateX("+halfsize.toFixed(1)+"px) rotateY(-90deg) rotateX(180deg) rotateZ(180deg)";break;
		case 'top': transform = "translateY(-"+halfsize.toFixed(1)+"px) rotateX(90deg) rotateZ(180deg)";break;
		case 'bottom': transform = "translateY("+halfsize.toFixed(1)+"px) rotateX(-90deg) rotateZ(180deg)";break;
		case 'back': transform = "translateZ("+halfsize.toFixed(1)+"px) rotateX(180deg) rotateY(180deg) rotateZ(180deg)";break;
