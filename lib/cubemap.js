...
Cubemap.prototype.buildFace = function(face, url)
{
	...
	switch(face)
	{
		case 'front': transform = "translateZ(-"+halfsize.toFixed(1)+"px) rotateY(180deg) rotateX(180deg) rotateZ(180deg)"; break;// VENT
		case 'left': transform = "translateX("+halfsize.toFixed(1)+"px) rotateY(90deg) rotateX(180deg) rotateZ(180deg)"; break; // EMPTY WALL
		case 'right': transform = "translateX(-"+halfsize.toFixed(1)+"px) rotateY(-90deg) rotateX(180deg) rotateZ(180deg)";break; // BED WALL
		case 'top': transform = "translateY(-"+halfsize.toFixed(1)+"px) rotateX(90deg) rotateY(180deg)";break; // CEILING
		case 'bottom': transform = "translateY("+halfsize.toFixed(1)+"px) rotateX(-90deg) rotateY(180deg)";break; // FLOOR
		case 'back': transform = "translateZ("+halfsize.toFixed(1)+"px) rotateX(180deg) rotateY(180deg) rotateZ(180deg)";break; // BARS
